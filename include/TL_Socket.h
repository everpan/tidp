...
namespace tidp {
    ...
    struct TL_Socket_Exception : public TL_Exp {

        TL_Socket_Exception(const std::string & buffer) : TL_Exp(buffer) {
        };

        TL_Socket_Exception(const std::string &buffer, int err) : TL_Exp(buffer, err) {
        };

        ~TL_Socket_Exception() throw () {
        };
    };
     ...
     * 建立链接异常
     */
    struct TL_SocketConnect_Exception : public TL_Socket_Exception {

        TL_SocketConnect_Exception(const std::string & buffer) : TL_Socket_Exception(buffer) {
        };

        TL_SocketConnect_Exception(const std::string &buffer, int err) : TL_Socket_Exception(buffer, err) {
        };

        ~TL_SocketConnect_Exception() throw () {
        };
    };
