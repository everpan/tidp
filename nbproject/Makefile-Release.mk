...
${OBJECTDIR}/src/TL_Cgi.o: src/TL_Cgi.cpp
	...
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -fPIC  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/TL_Cgi.o src/TL_Cgi.cpp

${OBJECTDIR}/src/TL_Client.o: src/TL_Client.cpp
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -fPIC  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/TL_Client.o src/TL_Client.cpp

${OBJECTDIR}/src/TL_Command.o: src/TL_Command.cpp
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -fPIC  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/TL_Command.o src/TL_Command.cpp

${OBJECTDIR}/src/TL_Common.o: src/TL_Common.cpp
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -fPIC  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/TL_Common.o src/TL_Common.cpp

${OBJECTDIR}/src/TL_Crontab.o: src/TL_Crontab.cpp
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -fPIC  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/TL_Crontab.o src/TL_Crontab.cpp

${OBJECTDIR}/src/TL_Datetime.o: src/TL_Datetime.cpp
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -fPIC  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/TL_Datetime.o src/TL_Datetime.cpp

${OBJECTDIR}/src/TL_Elapsed.o: src/TL_Elapsed.cpp
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -fPIC  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/TL_Elapsed.o src/TL_Elapsed.cpp

${OBJECTDIR}/src/TL_Exp.o: src/TL_Exp.cpp
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -fPIC  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/TL_Exp.o src/TL_Exp.cpp

${OBJECTDIR}/src/TL_Http.o: src/TL_Http.cpp
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -fPIC  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/TL_Http.o src/TL_Http.cpp

${OBJECTDIR}/src/TL_HttpRequest.o: src/TL_HttpRequest.cpp
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -fPIC  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/TL_HttpRequest.o src/TL_HttpRequest.cpp

${OBJECTDIR}/src/TL_HttpResponse.o: src/TL_HttpResponse.cpp
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -fPIC  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/TL_HttpResponse.o src/TL_HttpResponse.cpp

${OBJECTDIR}/src/TL_IniFile.o: src/TL_IniFile.cpp
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -fPIC  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/TL_IniFile.o src/TL_IniFile.cpp

${OBJECTDIR}/src/TL_Logger.o: src/TL_Logger.cpp
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -fPIC  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/TL_Logger.o src/TL_Logger.cpp

${OBJECTDIR}/src/TL_MD5.o: src/TL_MD5.cpp
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -fPIC  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/TL_MD5.o src/TL_MD5.cpp

${OBJECTDIR}/src/TL_MemQueue.o: src/TL_MemQueue.cpp
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -fPIC  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/TL_MemQueue.o src/TL_MemQueue.cpp

${OBJECTDIR}/src/TL_MemString.o: src/TL_MemString.cpp
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -fPIC  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/TL_MemString.o src/TL_MemString.cpp

${OBJECTDIR}/src/TL_Mmap.o: src/TL_Mmap.cpp
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -fPIC  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/TL_Mmap.o src/TL_Mmap.cpp

${OBJECTDIR}/src/TL_Mysql.o: src/TL_Mysql.cpp
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -fPIC  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/TL_Mysql.o src/TL_Mysql.cpp

${OBJECTDIR}/src/TL_MysqlPool.o: src/TL_MysqlPool.cpp
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -fPIC  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/TL_MysqlPool.o src/TL_MysqlPool.cpp

${OBJECTDIR}/src/TL_Option.o: src/TL_Option.cpp
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -fPIC  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/TL_Option.o src/TL_Option.cpp

${OBJECTDIR}/src/TL_Redis.o: src/TL_Redis.cpp
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -fPIC  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/TL_Redis.o src/TL_Redis.cpp

${OBJECTDIR}/src/TL_Rlog.o: src/TL_Rlog.cpp
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -fPIC  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/TL_Rlog.o src/TL_Rlog.cpp

${OBJECTDIR}/src/TL_StringBuffer.o: src/TL_StringBuffer.cpp
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -fPIC  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/TL_StringBuffer.o src/TL_StringBuffer.cpp

${OBJECTDIR}/src/TL_Thread.o: src/TL_Thread.cpp
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -fPIC  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/TL_Thread.o src/TL_Thread.cpp

${OBJECTDIR}/src/TL_ThreadLock.o: src/TL_ThreadLock.cpp
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -fPIC  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/TL_ThreadLock.o src/TL_ThreadLock.cpp

${OBJECTDIR}/src/TL_TimerProvide.o: src/TL_TimerProvide.cpp
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -fPIC  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/TL_TimerProvide.o src/TL_TimerProvide.cpp
