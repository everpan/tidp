...
namespace tidp {
    ...
    TL_Datetime::TL_Datetime(struct timeval tv) {
    ...
    struct timeval TL_Datetime::getTimeval() {
        return _tv;
    }
    ...
    std::string TL_Datetime::toString() {
        return TL_Datetime::tm2str(_tv.tv_sec, _tm_fmt);
    }

    std::string TL_Datetime::toString(const std::string &fmt) {
    ...
    const bool TL_Datetime::operator<(const TL_Datetime& d) {
        return _tv.tv_sec < d._tv.tv_sec ||
                (_tv.tv_sec == d._tv.tv_sec &&
                _tv.tv_usec < d._tv.tv_usec);
    }
